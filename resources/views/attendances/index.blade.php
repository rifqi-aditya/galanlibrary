                    ...
                    <div class="col-lg-7 p-4">
                        ...
                        <div class="guide-card bg-light-blue p-4 rounded-3">
                            <h5 class="d-flex align-items-center mb-3">
                                <i class="fas fa-info-circle me-2 text-primary"></i>Petunjuk Absensi
                            </h5>
                            <div class="guide-steps">
                                <div class="step d-flex mb-2">
                                    <div style="background-color: #E9A319"
                            ...
                            <form id="absensi-form" method="POST" action="{{ route('absensi.store') }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text text-white" style="background-color: #E9A319;">
                                            <i class="fas fa-barcode"></i>
                                        </span>
                                        <input type="text" class="form-control form-control-lg "
                                            style="border-color: #E9A319;" id="manual-barcode" name="barcode"
                                            placeholder="BRW-12345678" autocomplete="off">
                                    </div>
                                </div>

                                <button type="submit" class="btn btn-primary btn-lg w-100 py-3 shadow-sm">
                                    <i class="fas fa-paper-plane me-2"></i>Proses Absensi
                                </button>
                            </form>
    ...
    <script>
        ...
        // `
            ...
            await Swal.fire({
                title: "Mohon Tunggu!",
                text: "Memproses Absensi...",
                imageUrl: "{{ asset('svg/loading.gif') }}",
                showConfirmButton: false,
                imageWidth: 100,
                imageHeight: 100,
                timer: 2000,
