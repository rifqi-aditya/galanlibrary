...
@section('main')
    ...
    <form action="{{ route('book.update', ['book' => $book]) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <select name="publisher_id" id="publisher_id" class="form-control">
                @foreach ($publishers as $publisher)
                    <option {{ old('publisher_id', $book->publisher_id) == $publisher->id ? 'selected' : '' }}
                        value="{{ $publisher->id }}">
                ...
                <div class="mb-3">
                    ...
                    <select name="category_id" id="category_id" class="form-control">
                        @foreach ($categories as $category)
                            <option {{ old('category_id', $book->category_id) == $category->id ? 'selected' : '' }}
        ...
        <div>
            <a href="{{ route('book.show', ['book' => $book]) }}" class="btn btn-sm btn-outline-dark">Batal</a>
