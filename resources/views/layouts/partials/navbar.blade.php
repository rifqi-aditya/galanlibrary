     ...
     <div class="container">
         <div class="d-flex justify-content-between w-100">
             <div class="d-flex align-items-center">
                 @auth
                     <a class="text-black" style="font-weight: bold;text-decoration: none;display: flex; align-items: center"
             ...
             <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                 @auth
                     <ul class="navbar-nav me-auto">
                         @if (!auth()->user()->hasRole('administrator'))
                             <li class="nav-item">
                                 <a class="nav-link-2" style="padding-left: 30px" href="{{ route('page.survey') }}">Survei
                                     Kepuasan</a>
                             </li>
                         @endif
                     </ul>
                 ...
                 @else
                     <ul class="navbar-nav ms-auto">
                         ...
                         <li class="nav-item">
                             <a class="nav-link" href="/pusat-bantuan" style="color: gray;">Bantuan</a>
                         </li>
                         <li class="nav-item">
